...
async def scrape_rendered(
    ...
    *,
    ...
    return ScrapeRenderedOutput(url=url, markdown=markdown, truncated=truncated)


class RenderedSkill:
    name = "scrape_rendered"
    description = (
        "Render a JavaScript-heavy public page with a headless browser and extract Markdown. "
